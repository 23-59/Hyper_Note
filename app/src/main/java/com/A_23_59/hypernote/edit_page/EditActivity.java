...
public class EditActivity extends AppCompatActivity implements EditContract.ViewLayer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton confirmEdit=findViewById(R.id.btn_confirm_edit);

        confirmEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                presenterLayer.onConfirmButtonClicked(taskDetailEdit.getText().toString(),EditActivity.this, MoreBottomSheet.task);
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                presenterLayer.onDeleteButtonClicked(MoreBottomSheet.task,EditActivity.this);
            }
        });
    }
